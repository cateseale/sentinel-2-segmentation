...
arch = [
    ...
    # Block 2
    to_Conv_nolabel(name='conv3', s_filer=128, n_filer=(32, 32), offset="(1,0,0)", to="(pool_1-east)", width=3.5,
                    height=32, depth=32),
    ...
    # Block 3
    to_Conv_nolabel(name='conv5', s_filer=64, n_filer=(64, 64), offset="(1,0,0)", to="(pool_2-east)", width=4.5,
                    height=25, depth=25),
    ...
    # Block 4
    to_Conv_nolabel(name='conv7', s_filer=32, n_filer=(128, 128), offset="(1,0,0)", to="(pool_3-east)", width=5.5,
                    height=16, depth=16),
